...
class Umat extends Model
{
    ...
    public function handlePhotoMove()
    {
        ...
        if (is_null($this->foto_sb) || is_null($this->foto_kk) || is_null($this->foto_profil))
            return $this->preparePhotoMoveData();
            
        $oldDirectory = explode('/', $this->foto_profil);
    ...
    {
        return Mail::to('litbang.gmaklaten@gmail.com')->send(new UpdateNotificationMail($this));
    }
}
